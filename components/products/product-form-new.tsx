...
const ProductFormNew = forwardRef<ProductFormRef, ProductFormProps>(
  (props, ref) => {
    ...
    const validateForm = (): boolean => {
      ...
      if (
        !props.updateMode &&
        uploadedImages.filter((img) => img.image).length === 0
      ) {
      ...
      <div className="space-y-6">
        ...
        <div className="border rounded-xl p-6">
          ...
          <div className="mt-6 bg-yellow-50 dark:bg-yellow-900/20 text-muted-foreground p-4 rounded-xl border border-yellow-200 dark:border-yellow-800 flex gap-2">
            ...
            <div>
              ...
              <p>
                Make sure your product images are clear and show the item
                accurately.
              </p>
              <a href="#" className="text-primary hover:underline">
                Read more
          ...
          {errors.images && (
            <p className="text-destructive text-sm mt-2">{errors.images}</p>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="px-3 py-2 rounded-xl border">
            ...
            />
            {errors.sellerId && (
              <p className="text-destructive text-sm mt-1">{errors.sellerId}</p>
            )}
          </div>
          ...
          <div className="px-3 py-2 rounded-xl border">
            ...
            {errors.color && (
              <p className="text-destructive text-sm mt-1">{errors.color}</p>
            )}
          </div>
        </div>
