...
export default function SizeSettingModal({ isOpen, onClose, onSubmit, currentValues }: SizeSettingModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-[350px] rounded-2xl sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-center">Specify Size</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select value={measurements.size} onValueChange={(value) => updateMeasurement("size", value)}>
              <SelectTrigger>
