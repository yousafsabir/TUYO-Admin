...
export function DebugInfo() {
  ...
  return (
    <div className="fixed bottom-4 right-4 w-80 bg-white p-4 shadow-lg rounded-lg border z-50">
      ...
      <div className="space-y-2 text-sm">
        ...
        {Object.entries(envVars).map(([key, value]) => (
          <div key={key} className="p-1 bg-gray-100 rounded text-xs break-all">
        ...
        {apiInfo && <div className="p-2 bg-gray-100 rounded text-xs break-all">{apiInfo}</div>}
