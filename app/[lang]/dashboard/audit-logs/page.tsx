  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">View and filter all administrative actions performed in the system.</p>
      </div>

      <AuditLogsFilters filters={filters} onFiltersChange={setFilters} dictionary={dictionary} />

      <AuditLogsTable filters={filters} onFiltersChange={setFilters} dictionary={dictionary} />
    </div>
  )
}
